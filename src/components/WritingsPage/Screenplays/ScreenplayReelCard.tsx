...
const ScreenplayFrame = ({ imagePath, title }: ScreenFrameProps) => {
    ...
    >
      <div className="relative w-64 md:w-80 h-48 md:h-60 border-4 border-gray-800/60 bg-gray-900/60">
        ...
        <figure className="flex items-center justify-center h-full px-4 overflow-hidden">
          ...
          />
          <figcaption
            className={`absolute inset-0 flex items-center justify-center  bg-gray-800/70  text-white text-center text-xl md:text-3xl font-bold p-2 transition-opacity duration-300 ${
